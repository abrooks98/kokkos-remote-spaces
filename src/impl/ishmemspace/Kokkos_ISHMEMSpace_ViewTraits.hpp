...
#ifndef KOKKOS_REMOTESPACES_ISHMEM_VIEWTRAITS_HPP
...
struct ViewTraits<void, Kokkos::Experimental::ISHMEMSpace, Properties...> {
  static_assert(
  ...
  using execution_space =
      typename Kokkos::Experimental::ISHMEMSpace::execution_space;
  using memory_space =
      typename Kokkos::Experimental::ISHMEMSpace::memory_space;
...
template <class... Properties>
struct ViewTraits<
    void, Kokkos::Device<Kokkos::Experimental::SYCL, Kokkos::Experimental::ISHMEMSpace>,
    Properties...> {
  static_assert(
      std::is_same<typename ViewTraits<void, Properties...>::execution_space,
                   void>::value &&
...
#endif  // KOKKOS_REMOTESPACES_ISHMEM_VIEWTRAITS_HPP
